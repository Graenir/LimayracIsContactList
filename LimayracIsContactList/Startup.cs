...
namespace LimayracIsContactList
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<LimayracIsContactListContext>(options =>
                     options.UseSqlServer(Configuration.GetConnectionString("LimayracIsContactListContext")));
